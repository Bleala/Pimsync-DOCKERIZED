...
Please note, this policy applies to the **Docker packaging, configuration, and build process** of Pimsync. Vulnerabilities found in the Pimsync software itself should be reported directly to the upstream project, [whynothugo/pimsync](https://todo.sr.ht/~whynothugo/pimsync).
...
**[➡️ Report a Security Vulnerability Here](https://github.com/Bleala/Pimsync-DOCKERIZED/security/advisories/new)**
...
The public key and verification instructions are available in the project's [**README.md**](https://github.com/Bleala/Pimsync-DOCKERIZED#image-signing--verification).
